        ...
        <div class="col-12">
            ...
            <div class="col-md-5">
                ...
                <div class="product-details-thumbnail">
                    ...
                    <figure
                        ...
                        data-mfp-src="{{asset('img/product/product-details-1.png')}}"
                    >
                        <img
                        src="{{asset('img/product/product-details-1.png')}}"
                        alt="Product Details"
                        />
                    </figure>
                    <figure
                        class="pro-thumb-item"
                        data-mfp-src="{{asset('img/product/product-details-2.png')}}"
                    >
                        <img
                        src="{{asset('img/product/product-details-2.png')}}"
                        alt="Product Details"
                        />
                    </figure>
                    <figure
                        class="pro-thumb-item"
                        data-mfp-src="{{asset('img/product/product-details-3.png')}}"
                    >
                        <img
                        src="{{asset('img/product/product-details-3.png')}}"
                        alt="Product Details"
                        />
                    </figure>
                    <figure
                        class="pro-thumb-item"
                        data-mfp-src="{{asset('img/product/product-details-4.png')}}"
                    >
                        <img
                        src="{{asset('img/product/product-details-4.png')}}"
                        alt="Product Details"
                        />
                    </figure>
                    <figure
                        class="pro-thumb-item"
                        data-mfp-src="{{asset('img/product/product-details-5.png')}}"
                    >
                        <img
                        src="{{asset('img/product/product-details-5.png')}}"
                        alt="Product Details"
                        />
                    </figure>
                    </div>
                    ...
                    <a
                    href="#thumb-gallery"
                    class="btn-large-view btn-gallery-popup"
            ...
            <div class="col-md-7">
                ...
                <div class="prod-details-info-content">
                    ...
                    <h5 class="price">
                    <strong>Price:</strong>
                    <span class="price-amount">$325.00</span>
                    </h5>
                    <p>
            ...
            <div class="col-12">
                ...
                <ul
                    class="nav nav-tabs desc-review-tab-menu"
                    id="desc-review-tab"
                    role="tablist"
                >
                    <li>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="description-content">
                        ...
                        can be moulded into just about any shape and hardens
                        to provide a hard shell. Additives can make it water
                        resistant and it can be produced in a rainbow of
                        colours. Other materials being looked at include
                        paper clay, paper glue, paper cotton and even
                        washable paper.
                        </p>

                        <p>
                        Additives can make it water resistant and it can be
                        produced in a rainbow of colours. Other materials
                        being looked at include paper clay Lorem ipsum dolor
                    ...
                    <div class="product-rating-wrap">
                        ...
                        <div class="rating-item">
                            ...
                            <img
                                src="{{asset('img/extra/author-1.jpg')}}"
                                alt="author"
                            />
                            </div>
                            ...
                            <p>
                                Wonderful collection of WooThemes classics! A
                                must buy for all Woo fans.
                            </p>
                            </div>
                        </div>
                        ...
                        <div class="rating-item">
                            <div class="rating-author-pic">
                            <img
                                src="{{asset('img/extra/author-2.jpg')}}"
                                alt="author"
                            />
                            </div>
                            ...
                            <p>
                                Voluptatem quia voluptas sit aspernat uptatem
                                sequi Neque porro.
                            </p>
                            </div>
                        </div>
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="col-12">
                                ...
                                <label for="your-review" class="sr-only"
                                    >review</label
                                >
                                <textarea
                                    rows="4"

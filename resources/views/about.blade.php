    ...
    <div class="container">
        ...
        <div class="col-lg-6 order-1 order-md-0">
            ...
            <p>
                ...
                internal combustion engines which are manufactured components
                of automobiles.
            </p>
            <p>
            ...
            <p>
                ...
                wind, though not as completely as in a car, whereas on sports
                and racing motorcycles the main function is reducing drag when
                the rider
            </p>
            </div>
        </div>
        ...
        <div class="col-lg-6 order-0">
            ...
            <img src="{{asset('img/banner/a-1.jpg')}}" alt="About" />
            </div>
        </div>
        </div>
        ...
        <div class="col-lg-6">
            ...
            <img src="{{asset('img/banner/a-2.jpg')}}" alt="About" />
            <a
                href="https://www.youtube.com/watch?=17&v=S-UcVwzrAqo"
                class="btn-video-popup"
                ><i class="ion-play"></i
            ></a>
            </div>
        </div>
...
<div class="newsletter-area-wrapper sp-lg-top sp-md-top mt-0">
    ...
    <div
        ...
        data-bg="{{asset('img/bg/newsletter-bg-2.jpg')}}"
    >
        <div class="row">
...
<div class="need-help-area bg-img sm-top" data-bg="{{asset('img/bg/bg-2.jpg')}}">
    <div class="container">
    <div class="row align-items-center">
